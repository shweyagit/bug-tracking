...
st.set_page_config(page_title="SportIQ CI Bug Dashboard", page_icon=ICON, layout="wide")
page_setup()

st.title("SportIQ CI Bug Dashboard")
st.markdown("Enterprise bug intelligence powered by GitHub Actions, TestRail, Jira, and Claude AI.")
